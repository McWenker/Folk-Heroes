...
namespace UnityEngine.Tilemaps
{
    ...
    public class TerrainTile : TileBase
    {
        ...
        public TileBase[] friendlyTiles;
        public TileBase reversionTile;
    ...
    public class TerrainTileEditor : Editor
    {
        ...
        {
            if(tile.friendlyTiles == null || tile.friendlyTiles.Length != 5)
            {
                tile.friendlyTiles = new TileBase[5];
        ...
        {
            EditorGUILayout.LabelField("Place any friendly TerrainTiles here.");
            EditorGUILayout.Space();

            EditorGUI.BeginChangeCheck();
            tile.friendlyTiles[0] = (TileBase) EditorGUILayout.ObjectField("Friendly Tile 1", tile.friendlyTiles[0], typeof(TileBase), false, null);
            tile.friendlyTiles[1] = (TileBase) EditorGUILayout.ObjectField("Friendly Tile 2", tile.friendlyTiles[1], typeof(TileBase), false, null);
            tile.friendlyTiles[2] = (TileBase) EditorGUILayout.ObjectField("Friendly Tile 3", tile.friendlyTiles[2], typeof(TileBase), false, null);
            tile.friendlyTiles[3] = (TileBase) EditorGUILayout.ObjectField("Friendly Tile 4", tile.friendlyTiles[3], typeof(TileBase), false, null);
            tile.friendlyTiles[4] = (TileBase) EditorGUILayout.ObjectField("Friendly Tile 5", tile.friendlyTiles[4], typeof(TileBase), false, null);
            if (EditorGUI.EndChangeCheck())
                EditorUtility.SetDirty(tile);


            EditorGUILayout.LabelField("Place any TileBase here for the Tile to revert to.");
            EditorGUILayout.Space();

            EditorGUI.BeginChangeCheck();
            tile.reversionTile = (TileBase) EditorGUILayout.ObjectField("Reversion Tile", tile.reversionTile, typeof(TileBase), false, null);
            if(EditorGUI.EndChangeCheck())
                EditorUtility.SetDirty(tile);
