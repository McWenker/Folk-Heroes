...
public class Corridor
{
    ...
    public int corridorWidth;              // How many units wide the corridor is.
    ...
    public void SetupCorridor (Room room, IntRange length, IntRange width, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
    {
        ...
        corridorWidth = Mathf.Clamp(corridorWidth, 1, maxWidth);
    }
}